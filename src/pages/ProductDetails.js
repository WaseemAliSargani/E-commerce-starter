...
const ProductDetails = () => {
  ...
  // get the single product based on hte id
    ...
    <div className="container mx-auto">
      ...
      <div className='flex flex-col lg:flex-row items-center'>
        ...
        <div className='flex-1 text-center lg:text-left'>
          ...
          <button onClick={() => addToCart(product, product.id)} className='bg-primary py-4 px-8 text-white active:bg-primary/80'>Add to cart</button>
        </div>
